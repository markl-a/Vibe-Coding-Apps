# Product Showcase - AI 智能電商平台 🤖

一個現代化的電子商務產品展示網站，使用 Next.js 14、TypeScript 和 Tailwind CSS 構建，並集成了強大的 AI 功能。

## ✨ 新增功能 (v2.0)

### 🤖 AI 功能
- **AI 產品推薦系統** - 基於內容和協同過濾的智能推薦
- **AI 智能客服** - 24/7 在線聊天機器人，自動回答常見問題
- **智能搜索** - 多維度搜索評分系統
- **個性化推薦** - 基於用戶行為的個性化商品推薦
...
### 🔍 SEO 優化
- **結構化數據** - JSON-LD Schema.org 支持
- **動態元數據** - 每個頁面優化的 meta 標籤
- **Sitemap** - 自動生成網站地圖
- **Robots.txt** - 搜索引擎爬蟲優化
...
### 📱 PWA 支持
- **Web App Manifest** - 可安裝到主屏幕
- **離線支持** - Service Worker（即將推出）
